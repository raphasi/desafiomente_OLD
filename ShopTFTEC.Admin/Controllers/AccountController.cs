...
public class AccountController : Controller
{
    ...
    public async Task<IActionResult> Register(RegisterViewModel model)
    {
        if (ModelState.IsValid)
        {
            ...
            foreach (var error in result.Errors)
            {
                ...
                if (error.Description.Contains("Passwords must be at least 6 characters."))
    ...
    [HttpPost]
    public async Task<IActionResult> LoginAdm(LoginAdmViewModel model)
    {
        if (ModelState.IsValid)
        {
            // Copia os dados do RegisterViewModel para o IdentityUser
            ...
            ModelState.AddModelError(string.Empty, "<div class=\"alert alert-dismissible alert-warning\">\r\n  <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\"></button>\r\n  <h4 class=\"alert-heading\">Warning!</h4>\r\n  <p class=\"mb-0\">Best check yo self, you're not looking too good. Nulla vitae elit libero, a pharetra augue. Praesent commodo cursus magna, <a href=\"#\" class=\"alert-link\">vel scelerisque nisl consectetur et</a>.</p>\r\n</div>");
        }
